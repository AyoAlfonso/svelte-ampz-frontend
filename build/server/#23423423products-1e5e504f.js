...
/* src/routes/#23423423products.svelte generated by Svelte v3.16.0 */

const _23423423products = index.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<main>
<div class="${"wrapper product"}">
    <div class="${"nav"}">
        ...
        <ul class="${"nav-items"}">
            ...
            <li class="${"active"}"><a href="${"/go"}">Products</a></li>
            <li><a href="${"/go"}">Opportunities</a></li>
...
exports.default = _23423423products;
