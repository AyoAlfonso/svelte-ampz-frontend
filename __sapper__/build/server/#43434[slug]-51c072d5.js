...
/* src/routes/details/_ProductDetails.svelte generated by Svelte v3.16.0 */
...
/* src/routes/details/_Breadcrumb.svelte generated by Svelte v3.16.0 */

const css = {
	code: "i.svelte-b9u2dn{margin:2px}",
...
const Breadcrumb = index.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <a href="${"/"}" rel="${"prefetch"}">Home</a>
  <i class="${"fa fa-angle-right svelte-b9u2dn"}" aria-hidden="${"true"}"></i>
...
const ProductImage = index.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
  ...
  <div class="${"flex-1 xs:order-1 md:order-2 overflow-hidden"}">
    <img${index.add_attribute("src", $session.settings.CDN_URL + currentImage + "?tr=w-3,h-3", 0)}${index.add_attribute("data-src", $session.settings.CDN_URL + currentImage, 0)}${index.add_attribute("alt", product.name, 0)} class="${"w-full zoom mb-3 svelte-12vyj7w"}" style="${"object-fit: contain; max-height:316px;"}">
  </div>
</div>`;
});

/* src/routes/#43434[slug].svelte generated by Svelte v3.16.0 */
