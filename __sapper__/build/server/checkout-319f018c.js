...
var index$3 = require('./index-8b72a3d8.js');
require('./index-eb724975.js');
var Header = require('./Header-06a48083.js');
require('./auth-0d05d7de.js');
var cart = require('./cart-bfa0ce7d.js');
var _CartBanners = require('./_CartBanners-3b22b83d.js');

/* src/components/ui/Textarea.svelte generated by Svelte v3.16.0 */

const css = {
	code: ".floating-label.svelte-q1bura{position:relative}.floating-input.svelte-q1bura{font-size:14px;padding:4px 4px;display:block;width:100%;padding:14px 12px 0;border:none}.floating-input.svelte-q1bura:focus{outline:none;border-bottom:2px solid red}label.svelte-q1bura{color:#999;font-size:16px;font-weight:normal;position:absolute;pointer-events:none;left:8px;top:13px;transition:0.2s ease all;-moz-transition:0.2s ease all;-webkit-transition:0.2s ease all}.floating-input:focus~label.svelte-q1bura,.floating-input:not(:placeholder-shown)~label.svelte-q1bura{top:-1px;font-size:14px;color:#555}.floating-select:focus~label.svelte-q1bura,.floating-select:not([value=\"\"]):valid~label.svelte-q1bura{top:-18px;font-size:14px;color:#555}",
...
const Textarea = index.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${index.escape(index.null_to_empty(cls)) + " svelte-q1bura"}">
  <div class="${"floating-label mb-10 svelte-q1bura"}">
    <textarea rows="${"4"}" class="${"floating-input bg-gray-100 border-b w-full rounded\n      hover:bg-gray-300 focus:outline-none focus:border-pink-500 svelte-q1bura"}"${index.add_attribute("placeholder", placeholder, 0)}${index.add_attribute("aria-label", label, 0)}>${value || ""}</textarea>
    <span class="${"highlight"}"></span>
    <label class="${"svelte-q1bura"}">${index.escape(label)}</label>
  </div>
</div>`;
});

/* src/routes/cart/checkout.svelte generated by Svelte v3.16.0 */
