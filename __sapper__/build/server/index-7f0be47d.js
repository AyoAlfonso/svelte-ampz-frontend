  ...
  <section class="${"about_part section_padding"}">
    <div class="${"container"}">
      ...
      <div class="${"row justify-content-between mt-5 pb-5 pt-5"}">
        <div class="${"col-md-6"}">
            <div class="${"about_part_img"}">
              <img class="${"img-rd-8 svelte-1g4xt23"}" src="${"img/ampz/Rectangle23.png"}" alt="${"ampz"}">
            </div>
          </div>
        <div class="${"col-md-6 push"}">
          <div style="${"margin-top: -1px;"}" class="${"white-f-x20 about_part_txt"}"> Talent </div>
      ...
      <div class="${"row justify-content-between mt-5 pb-5 pt-5"}">
          ...
          <div class="${"col-md-6"}">
              <div class="${"about_part_img"}">
                <img class="${"img-rd-8 svelte-1g4xt23"}" src="${"img/ampz/mya.png"}" alt="${"ampz"}">
              </div>
            </div>
        </div>
        ...
        <div class="${"row justify-content-between mt-5 pb-5 pt-5"}">
            <div class="${"col-md-6"}">
                <div class="${"about_part_img"}">
                  <img class="${"img-rd-8 svelte-1g4xt23"}" src="${"img/ampz/Rectangle54.png"}" alt="${"ampz"}">
                </div>
              </div>
