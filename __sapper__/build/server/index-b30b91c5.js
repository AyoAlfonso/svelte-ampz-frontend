...
const Opportunities = index.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<main class="${"white-bg-8 svelte-5ovwdf"}">
    <div class="${"wrapper opportunities"}">
        <div class="${"header"}">
            <div class="${"overlay"}">
                <div class="${"nav"}">
                    ...
                    <ul class="${"nav-items svelte-5ovwdf"}">
                     <li><a href="${"about-ampz"}" class="${"svelte-5ovwdf"}">About Us</a></li>
                         <li><a href="${"product"}" class="${"svelte-5ovwdf"}">Products</a></li>
                        <li class="${"active"}"><a href="${"opportunities"}" class="${"svelte-5ovwdf"}">Opportunities</a></li>
                    
                        
                      
                        <li><a href="${"waitlist"}" class="${"btn svelte-5ovwdf"}">Get Started</a></li>
                    </ul>
                    <i class="${"material-icons menu-btn"}">menu</i>
                </div>
                <div class="${"header-content"}">
	...
	? `<div class="${"grid-container"}">
        ${index.each(opportunities, opportunity => `<a${index.add_attribute("href", "/opportunities/" + opportunity._id, 0)}>
                <div class="${"item"}">
                    <div class="${"item-content"}">
                        <div class="${"img img1"}"></div>
                        <div class="${"text"}">
                            ...
                            <div class="${"main-text"}">
                                ...
                                <a${index.add_attribute("href", `/opportunities/` + opportunity._id, 0)} class="${"right"}">Read More</a>
                                <div class="${"clearfix"}"></div>
                            </div>
                        </div>
                    </div>
	...
	: `<div class="${"no-opportunity svelte-5ovwdf"}"> ${index.escape(opportunities_status)} </div>`}
