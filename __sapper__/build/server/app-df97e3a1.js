...
const components = [
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-7f0be47d.js')); }),
	...
	{
		js: () => new Promise(function (resolve) { resolve(require('./#34234234flipkart-5da1e141.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:#34234234flipkart.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-ea9a7e5b.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:opportunities/index.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./new-20810cdf.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:opportunities/new.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./[slug]-37b43277.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:opportunities/[slug].svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./#234234login-586e1133.js')); }),
	...
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-27180cdb.js')); }),
	...
	{
		js: () => new Promise(function (resolve) { resolve(require('./#43434[slug]-ca2539d6.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:#43434[slug].svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-32b7ffc2.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:search/index.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-7e44fbec.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:cart/index.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./order-success-95478cfc.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:cart/order-success.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./checkout-c2657906.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:cart/checkout.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./_layout-5b56a589.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/_layout.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-174112d8.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/index.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./password-8b6fe283.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/password.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./address-535dfc3f.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/address.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./profile-519dab9f.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/profile.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./orders-13d58bb5.js')); }),
