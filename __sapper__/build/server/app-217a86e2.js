...
const components = [
	...
	{
		js: () => new Promise(function (resolve) { resolve(require('./#34234234flipkart-ea9f6692.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:#34234234flipkart.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-534428eb.js')); }),
	...
	{
		js: () => new Promise(function (resolve) { resolve(require('./[slug]-1534d703.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:opportunities/[slug].svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./#234234login-ea570345.js')); }),
	...
	{
		js: () => new Promise(function (resolve) { resolve(require('./#43434[slug]-1c84f540.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:#43434[slug].svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-9d0e9849.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:search/index.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-8bedc8ff.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:cart/index.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./order-success-2f2276f6.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:cart/order-success.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./checkout-ca401d2e.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:cart/checkout.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./_layout-c2d6bd5d.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/_layout.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-a27eac1f.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/index.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./password-fdd19fe3.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/password.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./address-5581f191.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/address.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./profile-059f0995.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/profile.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./orders-0159b675.js')); }),
