...
/* node_modules/svelte-calendar/src/Components/Week.svelte generated by Svelte v3.16.0 */
...
/* node_modules/svelte-calendar/src/Components/Month.svelte generated by Svelte v3.16.0 */
...
/* node_modules/svelte-calendar/src/Components/NavBar.svelte generated by Svelte v3.16.0 */
...
/* node_modules/svelte-calendar/src/Components/Popover.svelte generated by Svelte v3.16.0 */
...
/* node_modules/svelte-calendar/src/Components/Datepicker.svelte generated by Svelte v3.16.0 */
...
const New = index.create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	let error = {
		...
		selected_sport_type: { message: "Select the sport type" },
...
<div class="${"wrapper new-opportunity"}">
    <div class="${"nav"}">
        ...
        <ul class="${"nav-items svelte-4cdkin"}">
           <li><a href="${"about-ampz"}" class="${"svelte-4cdkin"}">About Us</a></li>
            <li><a href="${"product"}" class="${"svelte-4cdkin"}">Products</a></li>
            <li><a href="${"opportunities"}" class="${"svelte-4cdkin"}">Opportunities</a></li>
          
            

            <li><a href="${"waitlist"}" class="${"btn svelte-4cdkin"}">Get Started</a></li>
        </ul>
        <i class="${"material-icons menu-btn"}">menu</i>
    </div>
    <div class="${"content"}">
        <div class="${"form"}">
            ...
            <h3 class="${"title"}">Create an opportunity.</h3>
            <div class="${"loader " + index.escape(loader_progress) + " svelte-4cdkin"}"></div>
       ...
       ${stage === 1
		? `<div class="${"upload input"}">
                ...
                ${form_a.Filesrc
			? `<h5 class="${"txt-green svelte-4cdkin"}">File Uploaded ! </h5>`
			: `<h5> Upload File </h5>`}
                <p>Drag and drop to upload pictures in JPG or PNG</p>
            ...
            <div class="${"gold-theme"}">
              ${index.validate_component(_apiv1.Select, "Select").$$render(
				$$result,
				{
					...
					placeholder: "State of your venue ...",
					selectedValue: form_a.location
				},
				{
					selectedValue: $$value => {
						form_a.location = $$value;
						$$settled = false;
					}
				},
				{}
        ...
        <div class="${"input"}">
        <span class="${"txt-ph svelte-4cdkin"}"> Programme date </span>
         ...
         <input class="${"txt-ph gold-theme svelte-4cdkin"}" type="${"text"}"${index.add_attribute("value", dDayInputText, 0)} placeholder="${"Pick a Date"}" required>
            ...
            <div class="${"input"}">
            <span class="${"txt-ph svelte-4cdkin"}"> Application Deadline... </span>
             ${index.validate_component(Datepicker, "Datepicker").$$render(
				$$result,
				{
					start: tomorrow,
          ...
          <input class="${"txt-ph svelte-4cdkin"}" id="${"opp_deadline"}" type="${"text"}"${index.add_attribute("value", deadlineInputText, 0)} placeholder="${"Pick a Date"}" required>
		...
		? `<div class="${"gold-theme mg-10"}">
           ...
           <div class="${"gold-theme mg-10"}">
            ...
            <button class="${"back-btn btn left svelte-4cdkin"}">Back</button>
