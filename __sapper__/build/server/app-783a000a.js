...
const components = [
	...
	{
		js: () => new Promise(function (resolve) { resolve(require('./#34234234flipkart-67ddf19f.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:#34234234flipkart.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-ec86229d.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:opportunities/index.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./new-51b85aab.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:opportunities/new.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./[slug]-a072b4e0.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:opportunities/[slug].svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./#234234login-b326d8a7.js')); }),
	...
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-1d886dc8.js')); }),
	...
	{
		js: () => new Promise(function (resolve) { resolve(require('./#43434[slug]-373850b7.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:#43434[slug].svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-c829f763.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:search/index.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-b78924ea.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:cart/index.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./order-success-6f8d371e.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:cart/order-success.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./checkout-f955307d.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:cart/checkout.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./_layout-7a794e44.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/_layout.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./index-77f10cdc.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/index.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./password-595e2051.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/password.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./address-db60f486.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/address.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./profile-1ca78df7.js')); }),
		css: "__SAPPER_CSS_PLACEHOLDER:my/profile.svelte__"
	},
	{
		js: () => new Promise(function (resolve) { resolve(require('./orders-005495a8.js')); }),
